...
public class GridBagManager {
     ...
     *
     * @param panel Das Panel (oder was auch immer) das verwaltet werden soll
     */
     ...
     *
     * @param panel Das Panel (oder was auch immer) das verwaltet werden soll
     * @param debug Debuggin einschalten
     */
     ...
     * Initialisiert den <code>GridBagManager</code>
     *
     * @param frame Das JFrame das verwaltet werden soll
     */
     ...
     * Initialisiert den <code>GridBagManager</code>
     *
     * @param dialog Der Dialog der verwaltet werden soll
     */
     ...
     *
     */
    public final GridBagManager reset() {
    ...
    /**
     * Setzt das Resizverhalten. Möglichkeiten: <code>GridBagConstraints.NONE</code>
     * <code>GridBagConstraints.HORIZONTAL</code> <code>GridBagConstraints.VERTICAL</code>
     *
     * @param fill Resizverhalten
     *
     * @return <code>GridBagManager this</code>
     */
    ...
    /**
     * Platzierung des Controls in einer zu grossen Zelle <code>GridBagConstraints.
     * ------------------------------------------------- <br>
    ...
    /**
     * Setzt den Komponent auf ein JScrollPanel bevor er geaddet wird, Vorsicht! Es muss das
     * zurückgegeben JPanel gelöscht werden, nicht den Komponent löschen! Dieser wird nicht
     * gefunden!
     *
     * @return <code>GridBagManager this</code>
     */
    ...
    /**
     * Setzt das gewichten beim resizen (1.0 ist standard)
     *
     * @param x Gewicht X
     * @return <code>GridBagManager this</code>
     */
    ...
    /**
     * Setzt den Component und added den Component auf das Frame. Die Aktion ist damit
     * abgeschlossen.
     *
     * @param component Component der geaddet werden soll
    ...
    public Component setComp(Component component) {
        ...
        if (scrollPanel) {
            JScrollPane pane = new JScrollPane(tempcomponent);
            gbl.setConstraints(pane, c);
            panel.add(pane);
            tempcomponent = pane;
        } else {
            gbl.setConstraints(tempcomponent, c);
            panel.add(tempcomponent);
        }
        // Erst am Schluss setzen, damit ggf. die Grösse des JScrollPane gesetzt
        // wird
        if (dim != null) {
            tempcomponent.setPreferredSize(dim);
        }

        addDebugItem(tempcomponent);
        reset();
     ...
     *
     * @param component zu entfernender <code>Component</code>
     */
    ...
    /**
     * Ersetzt ein <code>Component</code> mit einem neuen <code>Component</code>
     *
     * @param c1 Der alte <code>Component</code>
     * @param c2 Der neue <code>Component</code>
     * @return <code>GridBagManager this</code>
     */
    ...
    private static class DebugItem {
         ...
         */
        public DebugItem(int x, int y, int width, int height, Component component) {
            this.x = x;
            this.y = y;
            this.width = width;
            this.height = height;
         ...
         *
         * @param component zu suchender Komponent
    ...
    /**
     * Fügt ein Komponent in die DebugArrayList und prüft ob der Platz schon belegt ist, und
     * printet im Fehlerfall den Call Stack.
     *
     * @param component Komponent
     */
    private void addDebugItem(Component component) {
        ...
        for (DebugItem d : items) {
            if (d.isUsed(c.gridx, c.gridy, c.gridwidth, c.gridheight)) {
                new Exception("Diese Koordinate ist schon belegt!").printStackTrace();
                System.exit(1);
            }
        }
        items.add(new DebugItem(c.gridx, c.gridy, c.gridwidth, c.gridheight, component));
    }
    ...
    private void removeDebugItem(Component component) {
        ...
        new Exception("Fehler: Dieser Komponent ist nicht vorhanden!").printStackTrace();
        System.exit(1);
    }
