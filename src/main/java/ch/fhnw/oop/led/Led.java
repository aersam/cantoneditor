...
public class Led extends JComponent implements ActionListener {
    ...
    /**
     * Returns a rectangle representing the available space for drawing the component taking the
    ...
    public Dimension getMinimumSize() {
        /*
         * Return the default size of the component which will be used by ui-editors for
         * initialization
         */
    ...
    private BufferedImage createFrameImage(final int WIDTH, final int HEIGHT) {
        ...
        final Ellipse2D SHAPE = new Ellipse2D.Double(0.15 * IMAGE_WIDTH, 0.15 * IMAGE_HEIGHT, 0.7 * IMAGE_WIDTH,
                0.7 * IMAGE_HEIGHT);
        final Paint SHAPE_FILL = new LinearGradientPaint(new Point2D.Double(0.25 * IMAGE_WIDTH, 0.25 * IMAGE_HEIGHT),
                new Point2D.Double(0.7379036790187178 * IMAGE_WIDTH, 0.7379036790187178 * IMAGE_HEIGHT), new float[] {
                        0.0f, 0.15f, 0.26f, 0.261f, 0.85f, 1.0f }, new Color[] {
    ...
    private BufferedImage createLedOffImage(final int WIDTH, final int HEIGHT) {
        ...
        final int IMAGE_WIDTH = IMAGE.getWidth();
        final int IMAGE_HEIGHT = IMAGE.getHeight();
        final Ellipse2D GLOWOFF = new Ellipse2D.Double(0.25 * IMAGE_WIDTH, 0.25 * IMAGE_HEIGHT, 0.5 * IMAGE_WIDTH,
                0.5 * IMAGE_HEIGHT);
        final Paint GLOWOFF_FILL = new LinearGradientPaint(new Point2D.Double(0.33 * IMAGE_WIDTH, 0.33 * IMAGE_HEIGHT),
                new Point2D.Double(0.6694112549695429 * IMAGE_WIDTH, 0.6694112549695427 * IMAGE_HEIGHT), new float[] {
                        0.0f, 0.49f, 1.0f }, new Color[] { color.darker().darker(), color.darker().darker().darker(),
                        color.darker().darker() });
    ...
    private BufferedImage createLedOnImage(final int WIDTH, final int HEIGHT) {
        ...
        final int IMAGE_WIDTH = IMAGE.getWidth();
        final int IMAGE_HEIGHT = IMAGE.getHeight();
        final Ellipse2D GLOW = new Ellipse2D.Double(0.15 * IMAGE_WIDTH, 0.15 * IMAGE_HEIGHT, 0.7 * IMAGE_WIDTH,
                0.7 * IMAGE_HEIGHT);
        final Paint GLOW_FILL = new RadialGradientPaint(new Point2D.Double(0.5 * IMAGE_WIDTH, 0.5 * IMAGE_HEIGHT),
                0.35f * IMAGE_WIDTH, new float[] { 0.0f, 0.5f, 0.73f, 1.0f }, new Color[] { new Color(1f, 1f, 1f, 0f),
                        new Color(1f, 1f, 1f, 0f), new Color(color.getRed(), color.getGreen(), color.getBlue(), 153),
                        new Color(color.getRed(), color.getGreen(), color.getBlue(), 25) });
        G2.setPaint(GLOW_FILL);
        G2.fill(GLOW);

        final Ellipse2D ON = new Ellipse2D.Double(0.25 * IMAGE_WIDTH, 0.25 * IMAGE_HEIGHT, 0.5 * IMAGE_WIDTH,
                0.5 * IMAGE_HEIGHT);
        final Paint ON_FILL = new LinearGradientPaint(new Point2D.Double(0.33 * IMAGE_WIDTH, 0.33 * IMAGE_HEIGHT),
                new Point2D.Double(0.6694112549695429 * IMAGE_WIDTH, 0.6694112549695427 * IMAGE_HEIGHT), new float[] {
                        0.0f, 0.49f, 1.0f }, new Color[] { color, color.darker(), color.brighter() });
        G2.setPaint(ON_FILL);
        G2.fill(ON);
    ...
    private BufferedImage createHighlightImage(final int WIDTH, final int HEIGHT) {
        ...
        final int IMAGE_WIDTH = IMAGE.getWidth();
        final int IMAGE_HEIGHT = IMAGE.getHeight();
        final Ellipse2D SHAPE = new Ellipse2D.Double(0.3 * IMAGE_WIDTH, 0.3 * IMAGE_HEIGHT, 0.4 * IMAGE_WIDTH,
                0.4 * IMAGE_HEIGHT);
        final Paint SHAPE_FILL = new RadialGradientPaint(new Point2D.Double(0.35 * IMAGE_WIDTH, 0.35 * IMAGE_HEIGHT),
                0.205f * IMAGE_WIDTH, new float[] { 0.0f, 1.0f }, new Color[] {
